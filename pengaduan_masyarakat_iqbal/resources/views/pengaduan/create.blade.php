    ...
    <body>
        <div class="container">
            <div class="card mt-5">
                ...
                CRUD DATA PENGADUAN - <strong>TAMBAH DATA</strong> - <a href="https://www.malasngoding.com/category/laravel" target="_blank"></a>
                </div>
                <div class="card-body">
                    <br/>
                    <br/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_pengaduan" class="form-control" placeholder="tanggal pengaduan .."></textarea>
